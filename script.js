    ...
    function initAIChat() {
        ...
        function getAIResponse(text) {
            ...
            if (matchAny([/kontakt|contact|reach|call|kako|get in touch|kako kontaktirati/])) {
                return reply(
                    'Kontakt: Email info@neotel-media.hr, Telefon +385 95 2229994. Adresa: Alberta Ognjana Štrige 7, 10000 Zagreb. Radno vrijeme: Pon-Pet 09:00-17:00',
                    'Contact: Email info@neotel-media.hr, Phone +385 95 2229994. Address: Alberta Ognjana Štrige 7, 10000 Zagreb. Hours: Mon-Fri 09:00-17:00'
                );
            }
...
All websites are responsive, fast, SEO-optimized and secure!`
            ...
            if (matchAny([/početi|get started|kako početi|gdje početi|started/])) {
                return reply(
                    'Kontaktirajte nas na +385 95 2229994 ili info@neotel-media.hr. Raspravljat ćemo Vaše potrebe i kreirati prilagođeni plan.',
